...
function switchTheme(themeName) {
  ['background', 'nowPlaying', 'nextTanda', 'ribbon', 'cortina', 'announcement', "afterCumparsita", "playerStoppedPaused"].forEach(function( id ) {document.getElementById( id ).className = (themeName);});
   };
